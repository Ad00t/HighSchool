...
public class SortDetective
{
    ...
    private static SwingWorker<Integer, Void> worker;
    ...
    public static void endTime() {
        long t = System.nanoTime() - SortDetective.timer;
        System.out.println(t);
        SortDetective.display.setText(t + " ns");
    }
    ...
    private static class SortHandler extends SwingWorker<Integer, Void>
    {
        public Integer doInBackground() {
            try {
                int[] lengths = new int[]{ 1000, 2000, 3000, 4000, 6000, 10000, 15000 };
                int[] algs = new int[]{ 0, 1, 2, 3, 4, 5, 6 };
                for (int alg : algs) {
                    for (int n : lengths) {
                        if (n <= 0 || n > 9999999) {
                        ...
                        final int[] genArray = SortDetective.genArray(n, SortDetective.arrtypelist.getSelectedIndex());
                        SortDetective.display.setText("Sorting...");
                        SortDetective.startTime();
                        SortDetective.sort(genArray, alg);
